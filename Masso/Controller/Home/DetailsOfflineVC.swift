...
class DetailsOfflineVC: UIViewController {
...
//        self.lblRunningBy.text = obj.operatorName.capitalized
        ...
        self.lblHr.textColor = UIColor.init(red: 255.0/255.0, green: 255.0/255.0, blue: 255.0/255.0, alpha: 1.0)
        self.lblHr.font = UIFont(name: "Inter-Medium", size: 16)
        ...
        self.lblHr.text = String(calculatedHr + 5) + " hrs"
