...
class DetailsIdleVC: UIViewController {
    ...
    @IBOutlet weak var mHeighr: NSLayoutConstraint!
    ...
    func setUPUIForMachine(obj : controllersList)
    {
        ...
        // Create String
        let stringDate = obj.last_response
        ...
        let dateComing = dateFormatter.date(from: stringDate)
        let calculatedHr = Date().hours(from: dateComing!)
        self.lblPercentageOfMachine.text = String(calculatedHr + 5) + " hr"
        ...
        self.lblPercent.textColor = UIColor.init(red: 11.0/255.0, green: 160.0/255.0, blue: 107.0/255.0, alpha: 1.0)
        ...
        self.lblTextMachine.textColor = UIColor.init(red: 11.0/255.0, green: 160.0/255.0, blue: 107.0/255.0, alpha: 1.0)
        ...
        self.btnBell.tintColor = UIColor.init(red: 255.0/255.0, green: 255.0/255.0, blue: 255.0/255.0, alpha: 0.7)
