...
class StarRatingView: UIView {
    ...
    fileprivate let fullStarImage: UIImage = UIImage(named: "star_full") ?? UIImage()//(systemName: "star.fill")!
    fileprivate let halfStarImage: UIImage = UIImage(named: "star_Half") ?? UIImage()//(systemName: "star.lefthalf.fill")!
    fileprivate let emptyStarImage: UIImage = UIImage(named: "star_outline") ?? UIImage()//(systemName: "star")!
